function DetalharCurso()
{
    ...
    window.open(`./curso.html?objeto=${stringJson}`, "_popup", "menubar=0,resizable=no,width=600,height=300");
}
...
var cursos = [
     ...
     {Curso:"EA",
      ...
      descricao: `O profissional de eletrônica automotiva realiza diversas atividades no processo de produção de um veículo.`,
    },
    { Curso: "FB",
